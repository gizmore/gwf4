...
//	}
	...
	private static function getDefaults(GWF_LangTrans $lang)
	{
		...
		$temp = array(
			...
			# Defaults
			array('text', 'Defaults', 'GWF_SERVER_VERSION', 'APACHE2.2', 'Either APACHE2.2, APACHE2.4 or NGINX'),
...
#			array('text', 'Language', 'GWF_SUPPORTED_LANGS', 'en;de;fr;it;pl;hu;es;bs;et;fi;ur;tr;sq;nl;ru;cs;sr;lv', 'Separate 2 char ISO codes by semicolon. Currently (partially) Supported: en;de;fr;it;pl;hu;es;bs;et;fi;ur;tr;sq;nl;ru;cs;sr'),
			...
			# EMail
			array('int10', 'EMail', 'GWF_DEBUG_EMAIL', 31, 'Send Mail on errors? 0=NONE, 1=DB ERRORS, 2=PHP_ERRORS, 4=404, 8=403, 16=MailToScreen, 31=DEBUG)'),
