<?php
# By Lazer :)
define('GWF_JP_SITENAME', '競争します');
$lang = array(

	'pt_login' => 'ログオン'.GWF_JP_SITENAME,
	'title_login' => '',
	...
	'err_login' => '未知のログイン',
	'err_login2' => 'あなたは間違った秘密を入力しました。アカウントが%s時間ブロックされる前に、あなたは今%s回の試行を持っています。',
	'err_blocked' => '%s分に再度データを転送することができます。',

	'welcome' => 
		'%s こんにちは。'.GWF_JP_SITENAME.'にようこそ<br/><br/>'.
