<?php
$headers = array(
	array($lang->lang('th_group_id'), 'group_id', 'ASC'),
	array($lang->lang('th_group_memberc'), 'group_memberc', 'ASC'),
	array($lang->lang('th_group_name'), 'group_name', 'ASC'),
	array($lang->lang('th_group_join'), 'group_options&255', 'ASC'),
	array($lang->lang('th_group_view'), 'group_options&0xf00', 'ASC'),
	array($lang->lang('th_group_founder'), 'group_founder', 'ASC'),
	array($lang->lang('th_group_lang'), 'group_lang', 'ASC'),
	array($lang->lang('th_group_country'), 'group_country', 'ASC'),
);
